                            ...
                            <CarouselItem key={index} className="mt-9">
                                <div className="lg:flex items-center gap-11">
                                    <div className="flex items-start gap-11 lg:pr-20">
                                        <div>
                                            <Icon icon="ph:tooth" width={32} height={32} className="text-primary" />
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex items-center mt-8 gap-6">
                                                <Image
                                                    ...
                                                    width={100}
                                                    height={100}
                                                    className="rounded-full lg:hidden block object-cover w-[100px] h-[100px]"
                                                    unoptimized={true}
                                                />
                                                <div>
                                    ...
                                    <div className="w-full h-full rounded-2xl overflow-hidden">
                                        <Image
                                            ...
                                            width={400}
                                            height={400}
                                            className="lg:block hidden object-cover w-[400px] h-[400px]"
                                            unoptimized={true}
                                        />
                                    </div>
                                </div>
